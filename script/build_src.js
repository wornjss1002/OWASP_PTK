...
fs.copySync('./node_modules/lodash-es', 'src/ptk/packages/lodash-es', { recursive: true })
...
// }
// fs.copyFileSync('node_modules/wappalyzer/wappalyzer.js', 'src/ptk/packages/wappalyzer/wappalyzer.js');
...
fs.copyFile('./node_modules/datatables.net/js/dataTables.min.js', 'src/ptk/packages/jquery/jquery.dataTables.min.js', (err) => {
    if (err) throw err;
});
...
fs.copyFileSync('./node_modules/codemirror-minified/lib/codemirror.js', 'src/ptk/packages/codemirror/codemirror.js');
fs.copyFileSync('./node_modules/codemirror-minified/lib/codemirror.css', 'src/ptk/packages/codemirror/codemirror.css');
fs.copyFileSync('./node_modules/codemirror-minified/lib/codemirror.css', 'src/ptk/packages/codemirror/codemirror.css');
if (!fs.existsSync('src/ptk/packages/codemirror/addon/fold/')) {
    ...
    fs.mkdirSync('src/ptk/packages/codemirror/addon/search/', { recursive: true });
    fs.mkdirSync('src/ptk/packages/codemirror/addon/selection/', { recursive: true });
    ...
    fs.mkdirSync('src/ptk/packages/codemirror/mode/http/', { recursive: true });
    fs.mkdirSync('src/ptk/packages/codemirror/mode/htmlmixed/', { recursive: true });
    fs.mkdirSync('src/ptk/packages/codemirror/mode/css/', { recursive: true });
}
fs.copySync('./node_modules/codemirror-minified/addon/fold', 'src/ptk/packages/codemirror/addon/fold', { recursive: true })
fs.copySync('./node_modules/codemirror-minified/addon/search', 'src/ptk/packages/codemirror/addon/search', { recursive: true })
fs.copySync('./node_modules/codemirror-minified/addon/selection', 'src/ptk/packages/codemirror/addon/selection', { recursive: true })
...
fs.copySync('./node_modules/codemirror-minified/mode/http', 'src/ptk/packages/codemirror/mode/http', { recursive: true })
fs.copySync('./node_modules/codemirror-minified/mode/htmlmixed', 'src/ptk/packages/codemirror/mode/htmlmixed', { recursive: true })
fs.copySync('./node_modules/codemirror-minified/mode/css', 'src/ptk/packages/codemirror/mode/css', { recursive: true })
